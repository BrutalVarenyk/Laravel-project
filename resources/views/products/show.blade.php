...
{{--                    <img src="{{ $product->thumbnail }}" class="card-img-top" style="max-width: 100%; height: 400px; margin: 0 auto; display: none">--}}
                    <img src="{{ $product->thumbnail }}" class="card-img-top" style="max-width: 100%; height: 400px; margin: 0 auto; display: block">
                @endif
            </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        @else
                            <p>Price: <span style="text-decoration: line-through">{{ $product->price }}$</span>   {{ $product->getPrice() }}$      <span style="color: #761b18; margin-left:10px">-{{ $product->discount }}%</span></p>
                        @endif
                    </div>
                        <p>SKU: {{ $product->SKU }}</p>
                </div>
